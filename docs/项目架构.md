...
- [1 项目整体结构](#1-项目整体结构)
- [2 backend 模块详解](#2-backend-模块详解)
- [3 frontend 模块详解](#3-frontend-模块详解)
- [4 docs 模块详解](#4-docs-模块详解)
- [5 docker 模块详解](#5-docker-模块详解)
- [6 项目技术栈汇总](#6-项目技术栈汇总)
- [7 项目架构图](#7-项目架构图)
...
### 2.2.2 studio-manager（Manager服务启动模块）
...
### 2.2.3 studio-runtime（Runtime服务启动模块）
...
### 2.2.5 studio-runtime-service（Runtime服务业务实现）
