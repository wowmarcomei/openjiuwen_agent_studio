...
@Component({
  selector: 'edit-workflow-name',
  imports: [CommonModule, MODULES],
  templateUrl: './edit-workflow-name.component.html',
  styleUrls: ['./edit-workflow-name.component.less'],
  standalone: true,
  providers: [
    {
...
export class EditWorkflowNameComponent {
