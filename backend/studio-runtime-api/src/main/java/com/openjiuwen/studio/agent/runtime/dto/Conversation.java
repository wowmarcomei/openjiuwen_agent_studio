...
public class Conversation implements Serializable {
    ...
    @Valid
    @Size()
    private List<com.openjiuwen.studio.agent.common.dto.agent.Message> messageList = null;
    ...
    public List<com.openjiuwen.studio.agent.common.dto.agent.Message> getMessageList() {
        return messageList;
    }

    public Conversation setMessageList(List<com.openjiuwen.studio.agent.common.dto.agent.Message> messageList) {
