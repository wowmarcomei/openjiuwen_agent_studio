...
public class AdditionalQuestionsConfig implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.enable, additionalQuestionsConfig.enable) && Objects.equals(this.prompt,
            additionalQuestionsConfig.prompt);
    }

    @Override
    public int hashCode() {
        return Objects.hash(enable, prompt);
    }
